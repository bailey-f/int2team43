...
This is the coursework repo for Group 43 for the Intelligent Systems 2 module.
...
- [x] Inital working model
- [ ] Improve the model
- [ ] Saving the trained model
    - [ ] Tests for loading the trained model

See the [open issues](https://github.com/bailey-f/int2team43/issues) for a full list of proposed features (and known issues).
